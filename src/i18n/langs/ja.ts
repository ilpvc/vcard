export default {
    ...
    addPerson: {
        info: {
            title: 'あなたの情報',
            des: '連絡先情報を入力してください。すべての項目が必須ではありません。',
            img: '画像:',
            upload: 'アップロード',
            name: '名前',
            firstName: '名',
        ...
        address: {
            ...
            ThailandPlant: 'タイチョンブリ県シラチャー郡カオカンソン区品通工業園',
            JapanOffice: 'ワークスタイリング品川(東京都港区港南2丁目16—5 NBF品川タワ—5階、6階)',
            VietnamOffice: '平陽省順安市安福坊緑洲一別荘地'
        },
        company: {
